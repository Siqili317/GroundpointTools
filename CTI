...
Output_Slope.save(Project + "_" + Iter +"_" +"Slope")
...
# Process: Raster Calculator (2)
CTImin = arcpy.GetRasterProperties_management(CTI, "MINIMUM")
CTImin = float(CTImin.getOutput(0))
arcpy.AddMessage(CTImin)
CTImax = arcpy.GetRasterProperties_management(CTI, "MAXIMUM")
CTImax = float(CTImax.getOutput(0))
arcpy.AddMessage(CTImax)
nCTI = 1+(CTI - CTImin)*9/(CTImax - CTImin)
nCTI.save(Project + "_" + Iter +"_" +"nCTI")
